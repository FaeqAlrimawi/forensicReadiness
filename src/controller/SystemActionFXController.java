...
//  private TabPane                actionsTabPane;
  ...
  void addNewAction(ActionEvent event) {
    ...
    String pre = txtFieldPre.getText();
...
//    
//    AutoCompleteTextArea auto = new AutoCompleteTextArea(oldStr, newStr, pos, bound);
//    
//    
//  }
//  
  ...
  void showAction(final String actionName) {
    ...
    Platform.runLater(new Runnable() {
      ...
      public void run() {
        ...
        // if system action then view it by retrieving it pre and post from sys
        // handler
        ...
        // update pre
        txtFieldPre.setText(pre);

        // update post
        txtFieldPost.setText(post);
      }
    });
      ...
      checkBox.setOnAction(new EventHandler<ActionEvent>() {
        ...
        public void handle(ActionEvent event) {
          ...
          if (!checkBox.isSelected()) {
            ...
            // if the system has the action as remvoed but it is checked then
            // restore the action
            // if (SystemHandler.isRemoved(actionName)) {
            // boolean isRestored = SystemHandler.restoreAction(actionName);
            // if (isRestored) {
            // System.out.println("action [" + actionName + "] is restored");
            // }
            // }
            ...
            // if the system has the action but it is not checked then delete
            // the action
            // if (SystemHandler.hasAction(actionName)) {
            // boolean isRemoved = SystemHandler.deleteAction(actionName);
            //
            // if (isRemoved) {
            // System.out.println("action [" + actionName + "] is removed");
            //
            // }
            // }
          }
        ...
        public void handle(ActionEvent event) {
          ...
          if (checkBox.isSelected()) {
            ...
            if (!SystemHandler.hasAction(actionName)) {
              ...
              //
              // boolean isAdded = SystemHandler.addAction(actionName, pre,
              // post);
              // if (isAdded) {
              // System.out.println("action [" + actionName + "] is Added");
              // }
            }
            // else {
