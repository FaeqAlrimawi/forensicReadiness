...
public class PaneLayoutDemo extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        StackPane dotA = getDot("white", "1", 25);
        StackPane dotB = getDot("red", "B", 25);
        StackPane dotC = getDot("yellow", "C", 25);
        StackPane dotD = getDot("pink", "D", 25);
        StackPane dotE = getDot("silver", "E", 25);


        buildSingleDirectionalLine(dotA, dotB, pane, true, true, "enterRoom"); // A <--> B
        buildSingleDirectionalLine(dotB, dotC, pane, true, true, "connectToBusNetwork"); // B <--> C
        buildSingleDirectionalLine(dotC, dotD, pane, true, false, "DeleteThis"); // C --> D
...
//        pane.setStyle("-fx-background-color:white");
     ...
     */
    private void buildSingleDirectionalLine(StackPane startDot, StackPane endDot, Pane parent, boolean hasEndArrow, boolean hasStartArrow, String actionName) {
